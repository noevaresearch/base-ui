...
- [x] docs-chrome: layout shell (sidebar + header + typography)
      ...
      blocked-by: [docs-app: routing + layout shell]
      status: done
      commit: f76255061 (the inherited checkpoint: chrome + single-source cargo-leptos config, WIP preserved by the hourly snapshot 240d7a8f8) — the done-marking is this iteration's commit; its follow-up records the sha here
