    ...
    view! {
        <article class="docs-page">
            ...
            {api_part(
                ...
                "Props: children (Box<dyn Fn(FieldValidityPayload) -> AnyView>, required — a function that accepts the field validity state as an argument; the payload carries validity, value, error, errors, initialValue, and transitionStatus).",
