...
`wraps-external:` — the unit's `TODO.md` entry has no `wraps-external:` field (`TODO.md:1097-1113`), and the source confirms it: nothing here delegates to an external npm package; all behavior is in-repo.
