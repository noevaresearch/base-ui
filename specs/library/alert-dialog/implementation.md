...
`TODO.md` entry (`TODO.md:304-310`) has no `wraps-external:` field — confirmed by reading the
...
No `wraps-external:` field exists on this unit's TODO entry (`TODO.md:304-310`), so per the
