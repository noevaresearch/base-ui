...
documents WHY/HOW. The `TODO.md` entry (`TODO.md:373-384`) has no `wraps-external:` field, so
...
No `wraps-external:` field exists for this unit (`TODO.md:373-384`), so there is no external
