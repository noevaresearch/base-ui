...
documents WHY/HOW. The `TODO.md` entry (`TODO.md:368-374`) has no `wraps-external:` field, so
...
No `wraps-external:` field exists for this unit (`TODO.md:368-374`), so there is no external
