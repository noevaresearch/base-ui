...
documents WHY/HOW. The `TODO.md` entry (`TODO.md:364-370`) has no `wraps-external:` field, so
...
No `wraps-external:` field exists for this unit (`TODO.md:364-370`), so there is no external
