...
WHY/HOW. The `TODO.md` entry (`TODO.md:537-543`) has no `wraps-external:` field, so there is no
...
No `wraps-external:` field exists for this unit (`TODO.md:537-543`), so there is no external
