...
WHY/HOW. The `TODO.md` entry (`TODO.md:1061-1072`) has no `wraps-external:` field, so there is no
...
No `wraps-external:` field exists for this unit (`TODO.md:1061-1072`), so there is no external
